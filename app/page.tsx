    ...
    <div className="relative overflow-hidden bg-[var(--background)]">
      ...
      <header className="relative mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-6 sm:px-10">
        <div className="flex items-center gap-3">
          ...
          <a
            className="flex items-center gap-1 text-sm text-[var(--muted-foreground)] transition-colors hover:text-[var(--accent)]"
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-12 flex flex-col gap-4 sm:flex-row">
              <a
                ...
                href="https://chromewebstore.google.com/detail/tactus/nmhndbemnmmigjooiafblchoegecmkhh"
                rel="noopener noreferrer"
                target="_blank"
              >
                Chrome 商店
              ...
              <a
                className="min-h-[44px] rounded-md border border-[var(--accent)] px-8 py-3 text-center text-sm font-medium tracking-[0.05em] text-[var(--accent)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--accent)] hover:text-white"
                href="https://addons.mozilla.org/firefox/addon/tactus"
                rel="noopener noreferrer"
                target="_blank"
              >
                Firefox 商店
